...
# ⚡ Bolt: Cache scipy.signal.butter filter coefficients.
# Generating these coefficients is computationally expensive compared to the actual filtering operation (sosfilt).
# Since we typically use the same cutoff frequency and order repeatedly, caching eliminates redundant calculations.
