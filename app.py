...
def high_band_rms_db(path, cutoff_hz):
    ...
    # ⚡ Bolt: Use 50% overlap (hop_length=1024) instead of 75% (hop_length=512)
    # This gives a ~2x speedup for macroscopic STFT aggregation without losing signal integrity
