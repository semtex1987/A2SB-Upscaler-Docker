        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                staged_paths = gr.Textbox(
                    ...
                    lines=2,
                    info="Stage files directly on the pod (for example with runpodctl) and enter paths like /app/inputs/*.wav below to bypass browser upload.",
                )
                ...
                cutoff_choice = gr.Number(
                    ...
                    info="Set at or below where your source's content degrades. For MP3s, artifacts typically begin between 10–16 kHz depending on bitrate.",
                )
