        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                staged_paths = gr.Textbox(
                    ...
                    info="Optional: stage files directly on the pod (e.g. with runpodctl) and enter paths like /app/inputs/*.wav to bypass browser upload.",
                    lines=2,
                )
                ...
                batch_size = gr.Slider(
                    ...
                    info="Lower reduces VRAM usage, higher is faster. H100/H200 handles 16-32 well."
                )
