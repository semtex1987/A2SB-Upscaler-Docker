...
def is_likely_corrupted_audio(path):
    ...
    try:
        ...
        # spectral_flatness is very slow with default arguments (n_fft=2048, hop_length=512)
        # Increasing hop_length to 2048 gives a >100x speedup for macro-level noise checks
