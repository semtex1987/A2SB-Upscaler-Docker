    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                gr.Markdown("The results summary shows the high-band energy before and after restoration so you can verify the model added content above the cutoff.", elem_classes=["text-sm", "text-gray-500", "mb-1"])
