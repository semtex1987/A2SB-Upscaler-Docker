...
def high_band_rms_db(path, cutoff_hz):
    ...
    # ⚡ Bolt: Use hop_length=1024 (50% overlap) instead of 512 (75% overlap)
    # This provides a 2x speedup for macroscopic RMS aggregations without sacrificing
    # signal integrity (avoids Hann window blind spots of 0% overlap).
