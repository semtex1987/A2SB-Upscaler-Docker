...
def high_band_rms_db(path, cutoff_hz):
    ...
    # ⚡ Bolt: Use 50% overlap (hop_length=n_fft//2) instead of default 75% for macroscopic heuristic aggregation to improve speed
    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                gr.Markdown(
                    "Upload one or many audio files to restore them sequentially.<br>"
