...
def high_band_rms_db(path, cutoff_hz):
    ...
    # ⚡ Bolt: Increase hop_length to n_fft//2 (1024) for macroscopic heuristic calculation.
    # This provides a ~2x speedup over the 75% default overlap while preserving signal integrity.
