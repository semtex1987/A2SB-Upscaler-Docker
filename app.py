...
if __name__ == "__main__":
    ...
    with gr.Blocks() as demo:
        ...
        gr.Markdown("Upload one or many audio files to restore them sequentially.")
        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                staged_paths = gr.Textbox(
                    ...
                    lines=2,
                    info="Stage files directly on the pod (e.g., via runpodctl) and enter paths here to bypass browser upload.",
                )
                ...
                cutoff_choice = gr.Number(
                    ...
                    info="Set at or below where your source's content degrades. "
                         "For MP3s, artifacts typically begin between 10-16 kHz. "
                ...
                batch_size = gr.Slider(
                    ...
                    info="Lower batch size reduces VRAM usage but takes longer. For H100/H200, 16-32 is a good start.",
                )
                run_button = gr.Button("Process Batch", variant="primary")
                gr.Markdown(
                    "The summary below shows high-band energy before/after restoration to verify content was added.",
                    elem_classes=["text-sm", "text-gray-500", "mb-1"]
                )
