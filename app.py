    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                gr.Markdown(
                    "Supported formats: WAV, FLAC, MP3, OGG, M4A. Processed sequentially.",
                ...
                staged_paths = gr.Textbox(
                    ...
                    lines=2,
                    info="Bypass browser upload. Stage files directly on the pod (e.g. runpodctl) and use glob patterns.",
                )
                ...
                cutoff_choice = gr.Number(
                    ...
                    info="Set at or below where your source's content degrades (MP3s typically 10-16 kHz). Release checkpoints are weak above ~12 kHz.",
                )
                ...
                gr.Markdown(
                    "The summary shows high-band energy before and after restoration to verify model additions.",
                    elem_classes=["text-sm", "text-gray-500", "mb-1"]
                )
