...
def is_likely_corrupted_audio(path):
    ...
    try:
        ...
        # ⚡ Bolt: `librosa.feature.spectral_flatness` is very slow with default arguments
        # (hop_length=512). Increasing hop_length to 2048 matches n_fft and drastically speeds up
        # the macro-level noise check without significantly changing the mean flatness result.
