    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            with gr.Column(scale=1):
                gr.Markdown("Upload audio files to restore sequentially.", elem_classes=["text-sm", "text-gray-500", "mb-1"])
                input_files = gr.File(
                    file_count="multiple",
                    type="filepath",
                    file_types=["audio"],
                ...
                staged_paths = gr.Textbox(
                    ...
                    lines=2,
                    info="Bypass browser upload. E.g., /app/inputs/*.wav"
                )
                ...
                batch_size = gr.Slider(
                    ...
                    info="Lower size reduces VRAM. For H100/H200, 16-32 is a good start."
                )
