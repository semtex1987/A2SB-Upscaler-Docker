...
def high_band_rms_db(path, cutoff_hz):
    ...
    # ⚡ Bolt: Use 50% overlap (hop_length=1024) instead of 75% (512) for a ~2x speedup
    # Safe for macroscopic heuristic aggregations without changing the result significantly
