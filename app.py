...
def high_band_rms_db(path, cutoff_hz):
    ...
    # ⚡ Bolt: Use 50% overlap (hop_length=n_fft//2) instead of 75% for macroscopic aggregations
    # to speed up calculations without losing precision or risking blind spots.
