...
def high_band_rms_db(path, cutoff_hz):
    ...
    # ⚡ Bolt: Use 50% overlap (hop_length=1024) instead of 75% (512) for faster macroscopic heuristic aggregation
    # without sacrificing signal integrity (Hann window blind spots at 0% overlap).
