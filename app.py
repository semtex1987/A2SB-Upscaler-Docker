...
# ⚡ Bolt: Cache filter coefficients. scipy.signal.butter is computationally expensive
# compared to the actual filtering (sosfilt). Since we use standard cutoffs and
# sample rates, memoizing the SOS generation speeds up sequential/batch processing ~5x.
