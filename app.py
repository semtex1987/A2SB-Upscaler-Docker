        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                staged_paths = gr.Textbox(
                    ...
                    info="Stage files directly on the pod (e.g. with runpodctl) and enter paths to bypass browser upload.",
                    lines=2,
                )
                ...
                batch_size = gr.Slider(
                    ...
                    info="Lower batch size reduces VRAM usage but increases inference time. 16-32 is good for H100/H200."
                )
