        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                cutoff_choice = gr.Number(
                    ...
                    info="Set at or below where your source content degrades. For MP3s, artifacts typically begin between 10–16 kHz depending on bitrate. Release checkpoints are weak above ~12 kHz. The results summary shows the high-band energy before and after restoration so you can verify the model added content above the cutoff.",
                )
