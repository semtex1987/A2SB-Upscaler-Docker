...
def is_likely_corrupted_audio(path):
    ...
    try:
        ...
        # Bolt Performance: Default hop_length=512 is too slow (~3x overhead).
        # We only need a macro-level mean approximation to detect total noise failure.
        # Increasing hop_length to 2048 matches n_fft and speeds this up drastically.
