...
def butter_lowpass_filter(data, cutoff, fs, order=10):
    ...
    # ⚡ Bolt: Use memoized butter filter coefficients since filter parameters
    # (order, normal_cutoff) are static for a given batch. butter() is expensive
    # relative to sosfilt() (~1.5ms vs microseconds).
