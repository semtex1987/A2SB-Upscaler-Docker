        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                staged_paths = gr.Textbox(
                    ...
                    info="Bypass browser upload by staging files directly on the pod.",
                ...
                batch_size = gr.Slider(
                    ...
                    info="Lower reduces VRAM usage but increases inference time. 16-32 is a good starting range for H100/H200."
                )
                run_button = gr.Button("Process Batch", variant="primary")
                summary = gr.Markdown("No files processed yet.")
                gr.Markdown(
                    "The summary shows the high-band energy before and after restoration so you "
