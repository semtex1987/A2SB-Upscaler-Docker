        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                staged_paths = gr.Textbox(
                    ...
                    lines=2,
                    info="Stage files directly on the pod (for example with runpodctl) and enter paths to bypass browser upload.",
                )
                ...
                cutoff_choice = gr.Number(
                    ...
                    info="For MP3s, artifacts typically begin between 10–16 kHz. "
                ...
                batch_size = gr.Slider(
                    ...
                    info="Lower reduces VRAM usage, longer inference time. For H100/H200, 16-32 is a good starting range.",
                )
