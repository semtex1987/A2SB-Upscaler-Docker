...
if __name__ == "__main__":
    ...
    with gr.Blocks() as demo:
        ...
        gr.Markdown("Restore missing high frequencies and fix MP3 compression artifacts. Upload files below.")
        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                gr.Markdown("Optional: stage files directly on the pod (e.g. with runpodctl) and enter paths like /app/inputs/*.wav below to bypass browser upload.", elem_classes=["text-sm", "text-gray-500", "mb-1"])
                staged_paths = gr.Textbox(
                    label="Staged File Paths",
                ...
                cutoff_choice = gr.Number(
                    ...
                    info="Set at or below where your source content degrades. For MP3s, artifacts typically begin between 10–16 kHz depending on bitrate.",
                )
