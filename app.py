        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                staged_paths = gr.Textbox(
                    ...
                    info="Bypass browser upload by staging files directly on the pod (e.g. via runpodctl).",
                    lines=2,
                )
                ...
                batch_size = gr.Slider(
                    ...
                    info="Lower reduces VRAM, higher speeds inference. 16-32 is a good starting range for H100/H200."
                )
