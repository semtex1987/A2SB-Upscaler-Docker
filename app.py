...
def is_likely_corrupted_audio(path):
    ...
    try:
        ...
        # ⚡ Bolt: Increase n_fft and hop_length to drastically speed up spectral flatness calculation
        # Defaults (n_fft=2048, hop_length=512) are too slow for simple noise checking.
