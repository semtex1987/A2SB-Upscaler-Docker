...
def high_band_rms_db(path, cutoff_hz):
    ...
    # ⚡ Bolt: Increase hop_length to n_fft//2 (1024) for 50% overlap instead of default 75% (512).
    # This provides a ~2x speedup for this macroscopic RMS heuristic without sacrificing signal integrity.
