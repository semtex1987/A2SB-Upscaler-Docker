        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                cutoff_choice = gr.Number(
                    ...
                    info="Set the cutoff at or below where your source content degrades. "
                ...
                batch_size = gr.Slider(
                    ...
                    info="Lower batch size reduces VRAM usage at the cost of longer inference time. "
                         "For H100/H200, 16-32 is a good starting range."
                )
