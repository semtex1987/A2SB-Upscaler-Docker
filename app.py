...
def is_likely_corrupted_audio(path):
    ...
    try:
        ...
        # ⚡ Bolt: Increase hop_length and n_fft to drastically speed up macro-level noise checks
        # Default hop_length=512 is too fine-grained and slow for a simple validation heuristic.
