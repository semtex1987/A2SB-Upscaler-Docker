        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                staged_paths = gr.Textbox(
                    ...
                    info="Stage files directly on the pod and enter paths like /app/inputs/*.wav below to bypass browser upload.",
                ...
                gr.Markdown(
                    "The results summary shows the high-band energy before and after restoration so you can verify the model added content above the cutoff.",
                    elem_classes=["text-sm", "text-gray-500", "mb-1"]
                )
