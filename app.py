...
def is_likely_corrupted_audio(path):
    ...
    try:
        ...
        # ⚡ Bolt: Increase hop_length and n_fft to significantly speed up
        # the macro-level spectral flatness check (from ~26s to ~0.004s for 5s of audio)
        # as default parameters are an extreme bottleneck for this heuristic.
