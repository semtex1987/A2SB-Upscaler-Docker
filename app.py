    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                steps = gr.Slider(minimum=10, maximum=200, value=50, step=10, label="Steps (Quality)", info="For bandwidth extension, 50-100 steps is usually practical.")
                ...
                batch_size = gr.Slider(
                    ...
                    info="Lower batch size reduces VRAM usage but increases inference time. 16-32 is a good start for H100/H200.",
                )
