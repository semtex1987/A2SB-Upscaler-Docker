        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                cutoff_choice = gr.Number(
                    ...
                    info="Set at or below where your source's content degrades. Release checkpoints are weak above ~12 kHz. For MP3s, artifacts typically begin between 10–16 kHz. Check the summary to verify added high-band energy.",
                )
