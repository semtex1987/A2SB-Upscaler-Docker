    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                gr.Markdown(
                    "Upload one or many audio files to restore them sequentially.<br>Supported formats: WAV, FLAC, MP3, OGG, M4A",
                ...
                cutoff_choice = gr.Number(
                    ...
                    info="Set at or below where your source's content degrades. For MP3s, artifacts typically begin between 10–16 kHz. Release checkpoints are weak above ~12 kHz.",
                )
