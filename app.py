    ...
    with gr.Blocks() as demo:
        ...
        with gr.Row():
            with gr.Column(scale=1):
                gr.Markdown(
                    "**Tip:** Upload one or many audio files to restore them sequentially."
                )
                input_files = gr.File(
                    file_count="multiple",
                    type="filepath",
                ...
                staged_paths = gr.Textbox(
                    ...
                    info="Optional: stage files directly on the pod (e.g. with runpodctl) to bypass browser upload.",
                ...
                batch_size = gr.Slider(
                    ...
                    info="Lower batch size reduces VRAM usage but takes longer. H100/H200 typically handles 16-32."
                )
