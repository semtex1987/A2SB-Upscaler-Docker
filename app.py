        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                staged_paths = gr.Textbox(
                    ...
                    info="Stage files directly on the pod to bypass browser upload.",
                ...
                steps = gr.Slider(
                    ...
                    step=10,
                    label="Steps (Quality)",
                    info="For bandwidth extension, 50-100 steps is usually practical."
                )
                ...
                batch_size = gr.Slider(
                    ...
                    info="Lower size reduces VRAM usage at the cost of longer inference time. For H100/H200, 16-32 is a good starting range.",
                )
