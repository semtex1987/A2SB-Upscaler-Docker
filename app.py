        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                staged_paths = gr.Textbox(
                    ...
                    lines=2,
                    info="Stage files directly on the pod (for example with runpodctl) and enter paths here to bypass browser upload.",
                )
                ...
                cutoff_choice = gr.Number(
                    ...
                    info="Set at or below where your source content degrades (MP3 artifacts typically begin between 10–16 kHz). Release checkpoints are weak above ~12 kHz.",
                )
                batch_size = gr.Slider(
                    ...
                    info="Lower batch size reduces VRAM usage but takes longer. 16-32 is a good starting range for H100/H200.",
                )
