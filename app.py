...
def high_band_rms_db(path, cutoff_hz):
    ...
    # ⚡ Bolt: Use 50% overlap (hop_length=1024) instead of 75% (512) for heuristic aggregation.
    # Yields ~2x speedup in STFT computation without compromising RMS stability.
