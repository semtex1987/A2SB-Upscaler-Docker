...
def high_band_rms_db(path, cutoff_hz):
    ...
    # ⚡ Bolt: Increase hop_length to n_fft//2 for 50% overlap instead of default 75%
    # Provides ~1.5x speedup without sacrificing signal integrity for macroscopic heuristic
