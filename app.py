...
def is_likely_corrupted_audio(path):
    ...
    try:
        ...
        # librosa.feature.spectral_flatness is a severe computational bottleneck with default arguments (hop_length=512).
        # Explicitly increasing hop_length drastically speeds up computation for this macro-level metric approximation.
