...
def is_likely_corrupted_audio(path):
    ...
    try:
        ...
        # ⚡ Bolt: Increase hop_length and n_fft to significantly speed up computation.
        # This reduces calculation time for macro-level noise checks from O(seconds) to O(ms)
