...
def high_band_rms_db(path, cutoff_hz):
    ...
    # ⚡ Bolt: Optimize macroscopic STFT heuristic by reducing overlap to 50%.
    # Using hop_length=1024 (n_fft//2) instead of 512 provides a ~2x speedup
    # without sacrificing signal integrity or causing blind spots.
