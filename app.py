        ...
        with gr.Row():
            with gr.Column(scale=1):
                ...
                staged_paths = gr.Textbox(
                    ...
                    lines=2,
                    info="Stage files on the pod and enter paths to bypass browser upload.",
                )
                ...
                steps = gr.Slider(
                    ...
                    label="Steps (Quality)",
                    info="50-100 is usually the practical range for bandwidth extension.",
                )
                cutoff_choice = gr.Number(
                    ...
                    info="Set at or below where source degrades (MP3s typically 10-16kHz).",
                )
                batch_size = gr.Slider(
                    ...
                    info="Lower batch size reduces VRAM usage. H100/H200: 16-32 is a good start.",
                )
