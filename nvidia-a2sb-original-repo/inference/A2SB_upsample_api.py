...
def compute_rolloff_freq(audio_file, roll_percent=0.99):
    ...
    # ⚡ Bolt: Explicitly set hop_length and n_fft to 2048 to remove 75% STFT overlap.
    # This speeds up the rolloff calculation ~4x without compromising the mean rolloff estimate.
    rolloff = librosa.feature.spectral_rolloff(y=y, sr=sr, n_fft=2048, hop_length=2048, roll_percent=roll_percent)[0]
