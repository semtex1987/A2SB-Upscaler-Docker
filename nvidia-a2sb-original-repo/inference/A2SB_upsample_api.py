...
def compute_rolloff_freq(audio_file, roll_percent=0.99):
    ...
    # ⚡ Bolt: Increase hop_length to match n_fft to avoid 75% overlap overhead.
    # This speeds up the heuristic check significantly since we only need a rough average.
