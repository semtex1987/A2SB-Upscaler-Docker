...
def compute_rolloff_freq(audio_file, roll_percent=0.99):
    ...
    # Optimized: Explicitly increase hop_length and n_fft to reduce STFT overlap
    # and significantly speed up macroscopic heuristic checks (~7x faster).
    rolloff = librosa.feature.spectral_rolloff(y=y, sr=sr, roll_percent=roll_percent, hop_length=2048, n_fft=2048)[0]
