...
class TimePartitionedPretrainedSTFTBridgeModel(LightningModule):
    ...
    def ddpm_sample(self, x_1, t_steps=None, mask=None, mask_pred_x0=True,
        ...
        # ⚡ Bolt: Precalculate all temporal embeddings outside the loop in a single vectorized pass
        # This avoids executing the sinusoidal network O(N) times inside the tight sampling loop
