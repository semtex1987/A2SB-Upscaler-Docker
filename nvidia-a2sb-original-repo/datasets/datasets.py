...
class MixAudioDataset(torch.utils.data.Dataset):
    ...
    def load_wav_to_torch(self, audiopath, start_time=None, end_time=None):
        # ⚡ Bolt: Lazy load and process only the required segment instead of entire files
        ...
        # Load only necessary segment + tiny buffer for resampling artifacts
        ...
        # ⚡ Bolt: Slice exact segment length to prevent shape mismatches
