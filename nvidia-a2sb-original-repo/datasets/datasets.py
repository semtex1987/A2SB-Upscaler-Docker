...
class MixAudioDataset(torch.utils.data.Dataset):
    ...
    def load_wav_to_torch(self, audiopath, start_time=None, end_time=None):
        ...
        # This avoids massive redundant memory allocations and slow resampling overhead
        # for large source files. Fetch slightly more duration to ensure enough frames after resampling.
