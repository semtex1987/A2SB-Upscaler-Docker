...
class MixAudioDataset(torch.utils.data.Dataset):
    ...
    def load_wav_to_torch(self, audiopath, start_time=None, end_time=None):
        # ⚡ Bolt: Use librosa lazy loading to avoid reading entire file into memory
        ...
        load_duration = duration_sec + 0.05
        ...
        # We loaded a bit more, now strictly slice to the required segment_length
