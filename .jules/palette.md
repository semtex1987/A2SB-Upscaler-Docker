...
## 2026-07-13 - Contextual Help vs Wall of Text
**Learning:** Users often ignore large blocks of markdown instructions at the top of an app, making complex settings hard to understand.
**Action:** Move global instructions into localized component `info` properties to provide help text exactly where the user is making the decision.
