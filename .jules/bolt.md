...
## 2026-07-24 - Optimize STFT overlap for RMS aggregations
...
**Action:** Set hop_length=n_fft//2 for heuristic aggregations, but preserve higher overlaps for visual spectrograms.
