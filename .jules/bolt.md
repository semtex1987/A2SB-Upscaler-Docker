...
## 2026-05-04 - Precalculate ML state vars using batched logic
...
**Action:** When working on tight loop sampling operations, look for operations only dependent on `t_steps` and precalculate them using tensor batch dimensions outside the loop.
