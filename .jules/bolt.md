...
## 2024-05-20 - Optimize librosa.feature.spectral_flatness
...
**Action:** Always explicitly provide `n_fft` and `hop_length` when macro-level accuracy is sufficient, significantly reducing computation overhead.
