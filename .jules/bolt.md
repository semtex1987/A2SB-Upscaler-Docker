...
## 2024-05-19 - Cache SciPy Butterworth Filter Coefficients
**Learning:** `scipy.signal.butter` is computationally expensive relative to actual filtering operations (`sosfilt`). For functions using static cutoff frequencies and order, this causes redundant calculations during sequential or batch processing.
