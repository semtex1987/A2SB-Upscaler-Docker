...
## 2026-07-19 - Optimize STFT hop_length for macroscopic heuristics
...
**Action:** When computing macroscopic heuristics that aggregate STFT data (e.g., high-band RMS), set `hop_length=n_fft//2` instead of the default 25% overlap (or 0% overlap) to double speed while preserving signal integrity.
