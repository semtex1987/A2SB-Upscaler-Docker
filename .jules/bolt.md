...
## 2024-11-20 - STFT Overlap and Macroscopic Heuristics
...
**Action:** When optimizing STFT computations that are averaged over time, apply `hop_length=n_fft//2` instead of 0% overlap to preserve signal energy integrity across window boundaries.
