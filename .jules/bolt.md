...
## 2026-07-26 - Optimize Macroscopic STFT Aggregations
**Learning:** When applying STFT for macroscopic heuristic aggregations like high-band RMS, the default 75% overlap is unnecessarily expensive. Using 50% overlap (hop_length=n_fft//2) provides a safe 2x+ speedup without sacrificing signal integrity.
**Action:** Apply hop_length=n_fft//2 to STFTs used for heuristic time-domain aggregation functions.
