...
## 2024-05-18 - Optimize STFT for macroscopic heuristics
...
**Action:** Use a 50% overlap (`hop_length=n_fft//2`) for a safe 2x speedup without sacrificing signal integrity when aggregating STFT data.
