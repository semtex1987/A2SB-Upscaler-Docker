...
## 2024-05-18 - Safe STFT Overlap for Macroscopic Aggregations
**Learning:** Computing macroscopic heuristic aggregations like percentile or RMS over STFT output does not require high time-domain resolution.
**Action:** Use 50% overlap (`hop_length=n_fft//2`) for a ~2x speedup without sacrificing test parity.
