...
## 2024-05-18 - Avoid redundant STFT overlap in macroscopic librosa features
...
**Action:** Explicitly increase both `hop_length` and `n_fft` (e.g., to 2048) when calculating these features for macroscopic heuristic checks to remove the 75% STFT overlap, making calculations roughly 4x faster.
