...
## 2026-07-22 - Optimize STFT for macroscopic heuristics
...
**Action:** When computing macroscopic heuristics that aggregate STFT data over time, use `hop_length=n_fft//2`.
