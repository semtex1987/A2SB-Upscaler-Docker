...
## 2025-07-17 - Lazy Load Audio Segments
**Learning:** Loading entire audio files and applying librosa.resample before cropping is massively inefficient.
**Action:** Lazily load audio segments using librosa.load(..., offset, duration) before resampling, keeping duration slightly larger to guarantee sufficient frames.
