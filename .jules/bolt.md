...
## 2024-05-18 - Vectorize piece-wise max-pooling with reduceat
...
**Action:** Use native C-level vectorization via `np.maximum.reduceat(matrix, edges[:-1], axis=...)` to achieve significant speedups.
