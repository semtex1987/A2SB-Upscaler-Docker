...
## 2025-07-27 - Safe STFT overlap reduction for macroscopic heuristics
...
**Action:** Use a 50% overlap (`hop_length=n_fft//2`) for a safe ~4x speedup without sacrificing signal integrity for macroscopic aggregations.
