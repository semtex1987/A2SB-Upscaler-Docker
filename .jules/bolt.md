...
## 2026-05-14 - Optimize librosa.feature.spectral_* methods
...
**Action:** Explicitly increase both `hop_length` and `n_fft` (e.g., to 2048) when calculating these features for macroscopic heuristic checks to gain significant speedups without losing required accuracy.
